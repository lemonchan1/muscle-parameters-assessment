...
CONFIG_NAME = "custom/fifth_multiresunet.yaml"
...
metrics = torchmetrics.MetricCollection(
    [
        ...
        torchmetrics.Dice(num_classes=num_classes),
        ...
        torchmetrics.Specificity(task='multiclass', num_classes=num_classes),
    ...
    with torch.no_grad():
        ...
        for batch_data in tqdm(te_dataloader):
            ...
            for i in range(len(tpm)):
                fid = tid[i]
                tmp = Image.fromarray(tpm.astype(np.uint8), mode='L')
