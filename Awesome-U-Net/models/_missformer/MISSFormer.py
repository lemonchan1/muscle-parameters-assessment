...
class MISSFormer(nn.Module):
    def __init__(self, num_classes=9, in_ch=3, img_size=512,token_mlp_mode="mix_skip", encoder_pretrained=True):
        super().__init__()
        ...
        self.backbone = MiT(img_size, dims, layers,in_ch, token_mlp_mode)
